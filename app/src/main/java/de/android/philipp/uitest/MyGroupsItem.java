 ...
 */
public class MyGroupsItem extends RelativeLayout {
    ...
    public MyGroupsItem(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init();
    }

    public MyGroupsItem(Context context, AttributeSet attrs, int defStyle)
    {
